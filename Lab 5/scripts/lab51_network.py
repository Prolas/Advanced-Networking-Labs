...
def run():
    ...
    r1 = net.addHost('r1', ip='10.20.0.10/24', hostname='r1',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    ...
    """
        ...
        bw = None,
 		...
 		max_queue_size = None 
    """
    link_h3r1.intf1.config( bw=7, enable_red=False,  enable_ecn=False)
