...
def run():
    ...
    link_h1sw1 = net.addLink(h1, sw1, cls=TCLink)
    link_h2sw1 = net.addLink(h2, sw1, cls=TCLink)
    link_r1sw1 = net.addLink(r1, sw1, intfName1="r1-eth0", cls=TCLink)
    link_h3r1 = net.addLink(
        r1, h3, intfName1="r1-eth1", cls=TCLink, bw=7, enable_red=True, enable_ecn=True
    )
